...
export function getStorageConfig() {
  ...
  return {
    ...
    uploadDir: root,
    minio: {
      endpoint: o.minio_endpoint || config.minio.endpoint,
      port: Number(o.minio_port || config.minio.port || 9000),
      useSSL: String(o.minio_use_ssl ?? config.minio.useSSL) === 'true',
...
/**
 * Open a readable stream for an object path (MinIO and/or local fallback).
 */
